    ...
    <div class="luxury-card tw-p-1 tw-rounded-xl tw-bg-white">
      <div class="tw-flex tw-flex-col">
        ...
        <div
          ...
          :class="{
            'tw-grid-cols-4':
              (!showLeftColumn && !showRightColumn && gridSize === 4) || gridSize === 4,
            'tw-grid-cols-3':
              (!showLeftColumn && !showRightColumn && gridSize === 3) || gridSize === 3,
            'tw-grid-cols-2':
              (!showLeftColumn && !showRightColumn && gridSize === 2) || gridSize === 2,
          }"
        >
          <CameraCard
